...
_HOSTNAME_CATEGORY_RULES: list[tuple[str, str]] = [
    ...
    (r"br[nw][0-9a-f]|brother|printer|print", CATEGORY_PRINTER),
    (r"nas\b|synology|diskstation|ds-?tom|cloud\d", CATEGORY_NAS),
    (r"router|gateway|^fritz\.box$", CATEGORY_ROUTER),
    (r"xps|thinkpad|latitude|elitebook|surface|inspiron|precision", CATEGORY_COMPUTER),
    ...
    (r"esp[-_]|esp8266|esp32|nodemcu|wlan0|roborock|vacuum|roomba", CATEGORY_IOT),
    (r"mi-\d|redmi|poco", CATEGORY_MOBILE),
